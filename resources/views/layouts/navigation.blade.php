<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 lg:flex">
                    ...
                    {{--
                    <x-nav-link :href="route('admin.app-config.index')" :active="request()->routeIs('admin.app-config.*')">
                        {{ __('App Config') }}
                    </x-nav-link>

                    <x-nav-link :href="route('fcm.index')" :active="request()->routeIs('fcm.*')">
                        {{ __('Notifications') }}
                    </x-nav-link> --}}
                </div>
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden lg:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('sms.index')" :active="request()->routeIs('sms.index')">
                {{ __('SMS') }}
            </x-responsive-nav-link>
            ...
            {{-- <x-responsive-nav-link :href="route('admin.app-config.index')" :active="request()->routeIs('admin.app-config.*')">
                {{ __('App Config') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('fcm.index')" :active="request()->routeIs('fcm.*')">
                {{ __('Notifications') }}
            </x-responsive-nav-link> --}}
        </div>
