                        ...
                        <div>
                            ...
                            <div id="imagePreviewContainer" class="hidden mb-4">
                                <div class="relative inline-block">
                                    <img id="imagePreview" src="" alt="Preview" class="h-48 w-64 object-cover rounded-lg shadow-md border border-gray-300 dark:border-gray-600">
                                    <button type="button" id="removeImage" class="absolute top-2 right-2 bg-red-500 text-white rounded-full p-1 hover:bg-red-600 transition duration-200">
                            ...
                            <!-- Upload Area -->
                            <div id="uploadArea" class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-md hover:border-gray-400 dark:hover:border-gray-500 transition duration-200">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <div class="flex space-x-2">
                                    <button type="button" id="previewBtn" class="px-3 py-1 text-sm bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 transition duration-200">
                                        <i class="fas fa-eye mr-1"></i>Preview
                                    </button>
                                    <button type="button" id="editBtn" class="px-3 py-1 text-sm bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 rounded-md hover:bg-blue-200 dark:hover:bg-blue-800 transition duration-200 hidden">
                            ...
                            <div id="editorContainer">
                                <div id="editor" class="border border-gray-300 dark:border-gray-600 rounded-md shadow-lg focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 @error('body') border-red-500 @enderror" style="height: 400px;">
                                </div>
                            </div>

                            <!-- Preview Container -->
                            <div id="previewContainer" class="hidden border border-gray-300 dark:border-gray-600 rounded-md shadow-lg bg-white dark:bg-gray-800 p-4" style="height: 400px; overflow-y: auto;">
                            ...
                            @error('body')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Use the rich text editor to format your content with headings, lists, links, and more. Click Preview to see how your post will look.</p>
                        </div>
