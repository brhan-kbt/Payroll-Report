        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-8">
                    <form action="{{ route('settings.update.afro') }}" method="POST" class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <!-- API Key -->
                            <div class="space-y-2">
                                <label class="flex items-center text-gray-700 dark:text-gray-300 font-semibold mb-3">
                ...
                <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-red-700 dark:text-red-400 text-sm">
                            <strong>Warning:</strong> Incorrect configuration will prevent SMS services from working.
                            Ensure all credentials are accurate and valid. Double-check your API keys and settings
                ...
                <div
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-gray-500 dark:text-gray-400 text-xs">Include country code (e.g., +251 for Ethiopia)</p>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <textarea id="testMessage"
                                    ...
                                    rows="4" placeholder="Enter your test message here...">AFRO SMS Test: Your configuration is working correctly! 🎉</textarea>
            ...
            <script>
                ...
                function sendTestSMS() {
                    ...
                    .then(data => {
                        if (data.success) {
                            showTestResult('✅ ' + (data.message || 'Test SMS sent successfully! Please check the recipient device.'), 'success');
                        } else {
                            showTestResult('❌ ' + (data.message || 'Failed to send SMS. Please check your configuration and try again.'), 'error');
                        }
                    })
                    .catch(error => {
