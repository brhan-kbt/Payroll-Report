    ...
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('Edit Setting: ') . ucfirst(str_replace('_', ' ', $setting->key)) }}
            </h2>
        </div>
    </x-slot>
                ...
                <div class="p-6">
                    <form action="{{ route('settings.update', $setting) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            @enderror
                            <p class="mt-1 text-sm text-gray-500">Example: about_us, privacy_policy, app_version</p>
                        </div>
                        ...
                        <div>
                            ...
                            <!-- Hidden textarea (stores Quill content) -->
                            <textarea name="value" id="value" class="hidden" required>{{ old('value', $setting->value) }}</textarea>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            if (typeof Quill !== 'undefined') {
                const quill = new Quill('#editor', {
                    ...
                    placeholder: 'Edit the setting value...'
                });
                ...
                // Ensure textarea updated before form submit
